...
WaterWidget 是一个面向慧生活798用户的第三方 Android 设备控制客户端，提供多账户管理、饮水设备启动与停止、钱包充值、用水消费统计、桌面小部件、快捷设置磁贴与设备二维码添加功能。(原项目地址[https://github.com/nocookies111/life-798](https://github.com/nocookies111/life-798))
